            ...
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-text text-muted">
                  ...
                  <br /> • Stripe payment platform integration; <br />• Combined
                  filters; <br />• Image loading with Cloudinary; <br />•
                  Cloudinary/upload/bucket; <br />• E-mail and live
                ...
                <p className="card-text text-muted">
                  ...
                  <br />
                  Javascript | Node.js | Express.js | JSON | Mongo Db | Mongoose
                  | HTML | React.js | Redux.js | CSS | Chakra UI | Cloudinary |
                  Firebase | Toastify | emailJS | Railway | Vercel | SCRUM
                </p>
              </div>
            </div>
          </Col>
            ...
            <div className="card">
              ...
              >
                ...
                <p className="card-text text-muted">
                  ...
                  <br /> • Combined filters and sorts; <br />• Combined filters;
                ...
                <p className="card-text text-muted">
                  ...
                  Sequelize | HTML | React.js | Redux.js | CSS Railway | Vercel
                  | Railway
                </p>
              </div>
            </div>
          ...
          >
            <div className="card">
              ...
              >
                ...
                <p className="card-text text-muted">
                  Henry Bootcamp. 1000 hours of a theoretical-practical course.
                </p>
                <br />
                <p className="card-text text-muted">
